...
const UI_TRANSLATIONS = {
  ...
  'Урок 4': 'Lesson 4',
  'Урок 5': 'Lesson 5',
  'Рецепція — «Come ti chiami?»': 'At reception — “Come ti chiami?”',
  'Перший діалог у міланському будинку, нові слова, культура розмови': 'Your first dialogue in a Milan apartment building, new words, and conversation customs.',
  '~15 хв': '~15 min',
  ...
  'Урок 1 · Рецепція': 'Lesson 1 · Reception',
  ...
  'Розділ 1': 'Unit 1',
  'Розділ 1 ›': 'Unit 1 ›',
  'Урок 1.1 · Рецепція': 'Lesson 1.1 · Reception',
  'Усі уроки →': 'All lessons →',
